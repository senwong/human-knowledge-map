...
export async function POST(request: Request) {
  ...
  return NextResponse.json({ action: 'publish', status: 'planned', manifest, note: 'Persistence is performed by the configured repository transaction layer.' }, { status: 202 });
}
